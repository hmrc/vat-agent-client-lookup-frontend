  ...
  "Deregistration Model" should {
    ...
    "deserialize from JSON" when {
      ...
      "date of cancellation is supplied" in {
        Json.obj("effectDateOfCancellation" -> "2019-01-01").as[Deregistration] shouldBe Deregistration(Some(LocalDate.parse("2019-01-01")))
      }
    ...
    "serialize to JSON" when {
      ...
      "date of cancellation is supplied" in {
        Json.toJson(Deregistration(Some(LocalDate.parse("2019-01-01")))) shouldBe Json.obj("effectDateOfCancellation" -> "2019-01-01")
      }
