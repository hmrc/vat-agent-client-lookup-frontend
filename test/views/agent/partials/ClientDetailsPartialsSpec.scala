...
class ClientDetailsPartialsSpec extends ViewBaseSpec {
  ...
  "ClientDetailsPartials" should {
    ...
    s"have the correct card heading" in {
      elementText(".heading-medium") shouldBe "Client details"
    }

    "display the correct line 1" in {
      elementText("#card-info") shouldBe "Change client business, contact and VAT details."
    }

    "display the correct line 2" in {
      elementText("#card-link") shouldBe "View your client's VAT details"
    }
