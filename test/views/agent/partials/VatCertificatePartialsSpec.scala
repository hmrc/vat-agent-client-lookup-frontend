...
class VatCertificatePartialsSpec extends ViewBaseSpec {
  ...
  "ClientDetailsPartials" should {
    ...
    s"have the correct card heading" in {
      elementText(".heading-medium") shouldBe "VAT certificate"
    }

    "display the correct line 1" in {
      elementText("#card-info") shouldBe "View and print your client's VAT certificate."
    }

    "display the correct line 2" in {
      elementText("#card-link") shouldBe "View VAT certificate"
    }

    "display the correct line 2 with the correct link" in {
      element("#card-link").attr("href") shouldBe "/certificate"
    }
  }
