...
notSignedUp.explanation = Ni allwch ddefnyddio’r gwasanaeth hwn ar gyfer busnes eich cleient gan nad yw’r busnes wedi cofrestru ar gyfer Troi Treth yn Ddigidol ar gyfer TAW.
notSignedUp.listHeading = Yr hyn sy’n digwydd nesaf
notSignedUp.listItem1Link = cofrestru ar gyfer Troi Treth yn Ddigidol ar gyfer TAW (yn agor tab newydd)
